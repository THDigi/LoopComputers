...
namespace Digi.Utils
{
    ...
    {
        public const string MOD_NAME = "LoopComputers";
        public const string MOD_FOLDER = "LoopComputers";
        public const int WORKSHOP_ID = 400037065;
        ...
        private static void WritePreInitMessages()
        {
